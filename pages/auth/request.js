    ...
    <>
          ...
          {submitted ? (
            <div className="d-flex" style={{ flexWrap: "wrap" }}>
              ...
              <p className="mt-3" style={{ width: "100%" }}>
                Thanks! Check your inbox for {getValues("email")} you'll get an
                email with a link to reset your password shortly. If it is
                missing please check your spam folder as well.
              </p>
            </div>
          ) : (
            <Form className="mt-2" onSubmit={handleSubmit(onSubmit)}>
              {errors.email ? (
                <p className="text-danger mb-4"> Please enter a valid email</p>
              ) : (
              ...
              <div className="in-group">
                ...
                <label className="in-label">
                  <Envelope className="mr-3 mb-1" size={20} />
                  Email
                </label>
              </div>
              <Row>
      ...
      >
        <Toast
          ...
          title="Reset Issue"
          error
          body={<h5 className="text-danger">{toastError}</h5>}
        />
      </div>
    </>
  )
