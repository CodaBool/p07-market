...
//       axios
//         .put("/api/auth/reset", { password: hash, token: router.query.id })
//         .then(res => {
...
//                 Your new password has been saved. You may now login with your
//                 new password.
//               </p>
//               <Button
//                 onClick={() =>
...
//                 <label className="in-label">
//                   <Key className="mr-2 mb-1" size={20} />
//                   {`${screen.includes("s") ? "Confirm" : "Confirm Password"}`}
//                 </label>
//               </div>
//               <Row>
//                 {submitting ? (
  ...
  return (
    <div className="container py-5">
      ...
      <p className="lead mb-4">
        Password reset is temporarily unavailable while the site is being
        updated.
      </p>
